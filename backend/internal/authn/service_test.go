...
import (
	...
	"github.com/thunder-id/thunder-id/tests/mocks/authn/assertmock"
	...
	"github.com/thunder-id/thunder-id/tests/mocks/authn/otpmock"
	"github.com/thunder-id/thunder-id/tests/mocks/authn/passkeymock"

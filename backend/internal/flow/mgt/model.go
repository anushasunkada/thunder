...
// CompleteFlowDefinition is defined in the driver-free flowdef package so the flow
// execution engine can reference it without importing flowmgt; aliased here for flowmgt's use.
type CompleteFlowDefinition = flowdef.CompleteFlowDefinition
...
// Flow-definition node model types are defined in the driver-free flowdef package
// (so the flow execution engine can reference them) and aliased here for flowmgt's use,
// including NodeDefinition's custom YAML (un)marshaling which lives with the type.
type (
	// NodeLayout is an alias of flowdef.NodeLayout.
	NodeLayout = flowdef.NodeLayout
	// NodeSize is an alias of flowdef.NodeSize.
	NodeSize = flowdef.NodeSize
	// NodePosition is an alias of flowdef.NodePosition.
	NodePosition = flowdef.NodePosition
	// NodeDefinition is an alias of flowdef.NodeDefinition.
	NodeDefinition = flowdef.NodeDefinition
	// InputDefinition is an alias of flowdef.InputDefinition.
	InputDefinition = flowdef.InputDefinition
	// ValidationRuleDefinition is an alias of flowdef.ValidationRuleDefinition.
	ValidationRuleDefinition = flowdef.ValidationRuleDefinition
	// ActionDefinition is an alias of flowdef.ActionDefinition.
	ActionDefinition = flowdef.ActionDefinition
	// PromptDefinition is an alias of flowdef.PromptDefinition.
	PromptDefinition = flowdef.PromptDefinition
	// ExecutorDefinition is an alias of flowdef.ExecutorDefinition.
	ExecutorDefinition = flowdef.ExecutorDefinition
	// ConditionDefinition is an alias of flowdef.ConditionDefinition.
	ConditionDefinition = flowdef.ConditionDefinition
)

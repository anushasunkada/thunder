...
type NodeDefinition struct {
	...
	Variant      string                 `json:"variant,omitempty" yaml:"variant,omitempty" jsonschema:"Optional PROMPT node variant. Use 'LOGIN_OPTIONS' to enable ACR-based filtering on this node."`

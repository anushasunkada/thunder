...
func (suite *InitTestSuite) TestInitialize() {
	...
	service := Initialize(mux, suite.mockAppService, suite.mockOUService, nil, &MockTransactioner{}, false)
...
func (suite *InitTestSuite) TestInitialize_RegistersRoutes() {
	...
	Initialize(mux, suite.mockAppService, suite.mockOUService, nil, &MockTransactioner{}, false)

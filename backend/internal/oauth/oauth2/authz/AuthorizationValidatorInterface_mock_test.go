...
func (_mock *AuthorizationValidatorInterfaceMock) validateInitialAuthorizationRequest(msg *OAuthMessage, oauthApp *thunderidengine.OAuthClient) (bool, string, string) {
	...
	var r1 string
	var r2 string
	if returnFunc, ok := ret.Get(0).(func(*OAuthMessage, *thunderidengine.OAuthClient) (bool, string, string)); ok {
		return returnFunc(msg, oauthApp)
	}
	if returnFunc, ok := ret.Get(0).(func(*OAuthMessage, *thunderidengine.OAuthClient) bool); ok {
		r0 = returnFunc(msg, oauthApp)
	} else {
		r0 = ret.Get(0).(bool)
	}
	if returnFunc, ok := ret.Get(1).(func(*OAuthMessage, *thunderidengine.OAuthClient) string); ok {
		r1 = returnFunc(msg, oauthApp)
	} else {
		r1 = ret.Get(1).(string)
	}
	if returnFunc, ok := ret.Get(2).(func(*OAuthMessage, *thunderidengine.OAuthClient) string); ok {
...
func (_c *AuthorizationValidatorInterfaceMock_validateInitialAuthorizationRequest_Call) Run(run func(msg *OAuthMessage, oauthApp *thunderidengine.OAuthClient)) *AuthorizationValidatorInterfaceMock_validateInitialAuthorizationRequest_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *OAuthMessage
		if args[0] != nil {
			arg0 = args[0].(*OAuthMessage)
		}
		var arg1 *thunderidengine.OAuthClient
		if args[1] != nil {
			arg1 = args[1].(*thunderidengine.OAuthClient)
		}
		run(
			arg0,
			arg1,
...
func (_c *AuthorizationValidatorInterfaceMock_validateInitialAuthorizationRequest_Call) RunAndReturn(run func(msg *OAuthMessage, oauthApp *thunderidengine.OAuthClient) (bool, string, string)) *AuthorizationValidatorInterfaceMock_validateInitialAuthorizationRequest_Call {
	_c.Call.Return(run)
	return _c
}

...
func (_c *AuthorizeServiceInterfaceMock_GetAuthorizationCodeDetails_Call) Return(v *AuthorizationCode, err error) *AuthorizeServiceInterfaceMock_GetAuthorizationCodeDetails_Call {

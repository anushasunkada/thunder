...
<ProductName /> includes a CLI scaffolding tool (`@thunder/create`) that generates production-ready feature packages. See the [Scaffolding Tool](scaffolding-tool.mdx) guide for details.

...
// TestCreateApplicationWithValidAcrValues verifies that an application can be created
// with a valid acr_values list and that the values are returned by GET.
...
// TestCreateApplicationWithInvalidAcrValues verifies that creating an application
...
// TestUpdateApplicationAcrValues verifies that acr_values can be added to an
...
// TestClearApplicationAcrValues verifies that acr_values can be removed from
...
func (ts *AcrValuesAPITestSuite) TestClearApplicationAcrValues() {
	...
	// Update: omit AcrValues to clear it
	cleared := app
